//
// FIR filter coefficients for 1.6MS/s to 16kS/s downsampling filters
//
// @author Johan Hedin
// @date   2021
//
...
#ifndef FS_01600_08BIT_DS_TO_00016_HPP
#define FS_01600_08BIT_DS_TO_00016_HPP

#include <vector>

// Summary
//
// This file contain filters that can be used for downsampling a 1.6MS/s 8-bit
// IQ stream from a RTL dongle to 16kS/s. The dynamic range of the 1.6MS/s
...
//
// Going from 1.6MS/s to 16kS/s requires a total reduction factor M of 100. This
// can be achieved with tree stages with M = 4, M = 5 and M = 5 in any order.
// The resulting dynamic range is ~70dB.
//
...
// from 1.6MS/s to 400kS/s (M = 4) and increases the dynamic range from ~50dB
// to ~56dB.
//
// Care band is between 0 and 10kHz and we want the attenuation in the folding
// areas (400 +/-10 kHz and 800 - 10 kHz in this case) to be more than 50dB.
//
...
//
//   > vectortocpp(c, "fs_01600_08bit_ds_lpf1_01600_to_00400")
//
static const std::vector<float> fs_01600_08bit_ds_lpf1_01600_to_00400 = {
     0.0000118076206669f,
     0.0008497497602583f,
     0.0066120963326192f,
     0.0258194357803837f,
...
// from 400kS/s to 80kS/s (M = 5) and increases the dynamic range from ~56dB
// to ~62.98dB.
//
// Care band is between 0 and 10kHz and we want the attenuation in the folding
...
//   > c = sincflt(21, fs, fcut, @parzenwin);
//   > c = sincflt(21, fs, fcut, @ultrwin, 1, 4.0);
//   > c = sincflt(19, fs, fcut+5, @ultrwin, 1, 3.0);
//   > c = sincflt(17, fs, fcut+10, @ultrwin, 1, 2.4);
//   >
//   > % Used as of 2021-11-29:
...
// Output the filter coefficients as a C++ float vector:
//
//   > vectortocpp(c, "fs_01600_08bit_ds_lpf2_00400_to_00080")
//
static const std::vector<float> fs_01600_08bit_ds_lpf2_00400_to_00080 = {
    -0.0015689596792550f,
    -0.0024762766140713f,
    -0.0014205974059769f,
     0.0053419181118151f,
...
// Output the filter coefficients as a C++ float vector:
//
//   > vectortocpp(c, "fs_01600_08bit_ds_lpf3_00080_to_00016")
//
static const std::vector<float> fs_01600_08bit_ds_lpf3_00080_to_00016 = {
    -0.0001088165129735f,
    -0.0002922217387049f,
    -0.0005887023450137f,
    -0.0008045434010244f,
...
#endif // FS_01600_08BIT_DS_TO_00016_HPP
